    ...
    <div class="pt-10 pb-10 text-text-color hidden md:block">
      <div class="flex justify-between items-center">
        ...
        <div class="flex gap-2 pt-[3px]">
          <img id="newarrivals-swiper-prev" src="../../assets/img/home/next-left.png" alt="prev"
            class="w-[23px] h-[23px] cursor-pointer" />
          <img id="newarrivals-swiper-next" src="../../assets/img/home/next-right.png" alt="next"
            class="w-[23px] h-[23px] cursor-pointer" />
        </div>
      </div>
        ...
        <SwiperSlide v-for="card in pros" :key="card.item_id">
          ...
          >
            ...
            <img src="../../assets/img/home/fav.png" alt="Heart Icon"
              class="absolute top-3 right-3 w-[20px] h-[20px] z-10" />

            <!-- Product Image -->
            <div class="h-[150px] flex items-center justify-center">
              <img :src="card.item_image_1 || '/placeholder.png'" alt="Product Img"
    ...
    <div class="block md:hidden py-10">
      ...
      <div class="grid grid-cols-2 gap-6">
        ...
        >
          ...
          <!-- Image -->
          <img :src="card.item_image_1 || '/placeholder.png'" alt="Product"
...
// ✅ Fetch featured items (already combined with prices in backend)
