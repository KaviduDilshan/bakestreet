        ...
        <SwiperSlide v-for="card in pros" :key="card.item_id">
          <div class="relative grid justify-items-center p-5 bg-[#F5F5F5] rounded-lg drop-shadow-xl mb-1"
            ...
            <img src="../../assets/img/home/fav.png" alt="Heart Icon"
              class="absolute top-3 right-3 w-[20px] h-[20px] cursor-pointer z-10" @click.stop="addToWishlist(card)" />
            ...
            <div class="pt-5 text-[14px] text-center font-[700] font-quicksand">
              {{ card.item_name }}
            </div>
            ...
            <!-- Sold -->
            <div class="text-[14px] font-[700] font-quicksand pt-2">
