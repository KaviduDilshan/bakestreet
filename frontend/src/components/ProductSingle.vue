...
<img
              ...
              />
              <span class="text-[#898989] text-sm lg:text-[11px]"
                >(3 Reviews)</span
              >
            </span>
          ...
          <div class="flex items-center mb-2">
             <span class="font-extrabold text-lg mr-4"
              >Rs.{{ formatPrice(displayedPrice) }}</span
            >
          </div>
          ...
          >
            ...
            <div class="flex gap-2 flex-wrap">
               <label
                v-for="varItem in attr.variations"
                :key="varItem.p1variation_id"
                class="flex items-center gap-1 cursor-pointer"
              >
                <input
                  type="radio"
                  :name="'attr_' + attr.attribute_id"
                  :value="varItem.p1variation_id"
          ...
          <!-- Quantity -->
          <div
            class="flex flex-col sm:flex-row items-center sm:justify-start w-full sm:max-w-xs mb-4 gap-4"
          >
            <div
              class="flex border border-[#A1A1A1] rounded overflow-hidden bg-white"
            >
              <button
                @click="decrement"
              ...
              <input
                type="number"
                :value="quantity"
                class="w-12 h-12 text-center border-0 font-medium"
                readonly
              />
              <button
                @click="increment"
          ...
          <div class="flex justify-center sm:justify-start w-full">
            <button
              class="h-12 px-[28px] text-white font-semibold rounded flex items-center justify-center transition"
              :class="{
      ...
      <div class="md:block hidden">
        <div
          class="flex justify-center space-x-8 border-b border-gray-200 mb-4 mt-8 text-sm lg:text-[15px] font-bold"
        >
          <button
            v-for="tab in tabs"
            :key="tab.name"
      ...
      >
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            ...
            <button
              class="mt-2 bg-secondary text-white px-4 py-2 rounded"
              @click="goToProduct(prod.item_id)"
            >
              View
            </button>
          </div>
